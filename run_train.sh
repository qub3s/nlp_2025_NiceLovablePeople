...
#SBATCH -t 01:45:00                  # estimated time # TODO: adapt to your needs
...
# QQP
echo -e "\nStarting QQP\n"
python multitask_classifier.py --use_gpu --option finetune --task qqp --hidden_dropout_prob 0.1 --epochs=3 --lr 1e-3 --batch_size 32
...
###! SLURM FILES ###
"""
10765022 = different init (05.09)
10764995 = reference part 1
