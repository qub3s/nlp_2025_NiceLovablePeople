...
#SBATCH -t 08:40:00                  # estimated time # TODO: adapt to your needs
...
# QQP
echo -e "\nStarting QQP\n"
python multitask_classifier.py --use_gpu --option finetune --task qqp --hidden_dropout_prob 0.1 --epochs=1 --use_pretrained_simcse --max_batches 10
